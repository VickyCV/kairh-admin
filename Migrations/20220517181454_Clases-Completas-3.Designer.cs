...
namespace kairh_admin.Migrations
{
    ...
    [Migration("20220517181454_Clases-Completas-3")]
    partial class ClasesCompletas3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kairh_admin.Models.pedido", b =>
                {
                    b.HasOne("kairh_admin.Models.cliente", null)
                        .WithMany("Pedidos")
                        .HasForeignKey("clienteId");

                    b.HasOne("kairh_admin.Models.negocio", null)
                        .WithMany("Pedidos")
                        .HasForeignKey("negocioid");

                    b.HasOne("kairh_admin.Models.repartidor", null)
                        .WithMany("Pedidos")
